    ...
    grecaptcha.ready(function () {
      return grecaptcha
        ...
        .then(async function (token) {
          ...
          const response = await fetch('/auth/api/createUser/', {
            method: 'POST',
            headers: {
...
$('#postCreateModal').on('show.bs.modal', function (event) {
  ...
  const recipient = button.data('post')
...
const createNewNode = function (username) {
...
const deleteUser = function (username) {
  const buttonwanted = $('.userControls')
  ...
  try {
    return grecaptcha
      ...
      .then(async function (token) {
        const response = await fetch('/auth/api/deleteUser/', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json'
          },
...
$('#passwordChangeForm').submit(function (event) {
  ...
  try {
    return grecaptcha
      ...
      .then(async function (token) {
        const response = await fetch('/blog/api/resetPassword', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json'
          },
...
$('#adminCreatePost').on('submit', async function (event) {
  ...
  const postStatus = await createBlogPost(
    $('#createPostTitle').val(),
...
const deletePost = function (title, elementId) {
  ...
  try {
    return grecaptcha
      ...
      .then(async function (token) {
        const response = await fetch('/blog/api/deletePost/', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json'
          },
...
const generate2FA = function () {
  ...
  try {
    grecaptcha
      ...
      .then(async function (token) {
        const response = await fetch('/auth/api/generate2FA/', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json'
          }
  ...
  try {
    grecaptcha
      ...
      .then(async function (token) {
        ...
        const response = await fetch('/auth/api/push2FA/', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json'
          },
